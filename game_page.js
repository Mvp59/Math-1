...
function send() {
    ...
    char1 = word.charAt(1);
    var dividing = Math.floor(word.length / 2);
    char2 = word.charAt(dividing);
    ...
    checkbuttton = "<br> <br> <button class='btn btn-info' onclick='check()'> check </button>";
    row = question_word + input_box + checkbuttton;
...
function check() {
    var getanswer = document.getElementById("input_checkbox").value;
